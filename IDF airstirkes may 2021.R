...
rocket_icon <- makeIcon(
  iconUrl ="https://www.freeiconspng.com/uploads/military-missile-icon-16.png",
...
note_1<- paste(sep = "<br/>",
               ...
               "Civilian and infrastructure casualties: 260 Palestinians killed including 65 children. 1,000 buildings destroyed"
)
addPopups(lng=34.3384552, lat=31.3244602, 
          note_1, popupOptions(closeButton = FALSE))
